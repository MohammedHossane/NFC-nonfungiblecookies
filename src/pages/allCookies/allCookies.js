...
export default function allCookies() {
  return (
    <div>
      <Header></Header>
      <img id="bannerSugarCookie" src={bannerSugarCookie} alt="bannerSugarCookie" />

      <img id="pinksugarcookie" src={pinksugarcookie} alt="pinksugarcookie" />
      <h1 id="pinkRow1"> Pink Unicorn Dust</h1>
      
      <img id="whitesugarcookie" src={whitesugarcookie} alt="whitesugarcookie" />
      <h1 id="snowRow1"> Snow White White</h1>

      <img id="invisiblesugarcookie" src={invisiblesugarcookie} alt="invisiblesugarcookie" />
